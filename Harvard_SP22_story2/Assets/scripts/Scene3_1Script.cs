...
public void talking(){         // main story function. Players hit next to progress to next int
        ...
        if (primeInt == 1){
               ...
               Char3name.text = "";
                ...
                Char2name.text = "What is it, Rory?";
                Char2speech.text = "";
               Char3name.text = "";
        }
       else if (primeInt == 5){
...
Char1name.text = "YOU";
                Char1speech.text = "Tell them on the open Channel. Let's have a chat with our new neighbors";
                Char2name.text = "";
                Char2speech.text = "";
               Char3name.text = "";
                Char3speech.text = "";
...
Char1name.text = "YOU";
                Char1speech.text = "Neither do I... But I know what General Lome would say.";
                Char2name.text = "";
      Char2speech.text = "";
               Char3name.text = "";
                Char3speech.text = "";
